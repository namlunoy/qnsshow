...
public class MainProgram {
	...
	public static void CapNhatLinkFullMp3QnS()
	{
		List<Show> list = MySQLite.getInstance().getAllTheShow();
		for (Show s : list) {
			if (s.getQns_url() != null && !s.getQns_url().equals("null")
					&& s.getFullMp3Url() == null) {

				String html = HttpWork.GetStringFromURL(s.getQns_url());
				if (html != null) {
					String mp3 = CollectData.getMp3FromQnS(html);
					s.setFullMp3Url(mp3);
					MySQLite.getInstance().UpdateFullMp3(s);
				}
	...
	public static void XuLyTrang_1_2_32_QnSdotVN() {
		// Trang 1
		String html = HttpWork
				.GetStringFromURL("http://qns.vn/All-QuickAndSnow.html");
		...
		hp.VIEWSTATE = HttpWork
				.encode("");
		hp.EVENTVALIDATION = HttpWork
				.encode("/wEWCQLK8IYdApqj/5sEAt/vr4cJAuTbsKYMAtCIv/8MAs+Iv/8MAtKIv/8MAtGIv/8MAsuIv/8MRT9NElclY2aTMxHSend33dPEZtE=");
		html = HttpWork.getHtmlFromWithHeaderParam(hp);
		list = CollectData.getListShowFromQnSHtml(html);
		MySQLite.getInstance().SyncListShowWithFullMp3AndNumber(list);
	...
	public static void XuLyTu3_31_QnSdotVN() {
		...
		for (int chap = 1; chap <= 6; chap++) {
			for (int page = 2; page <= 5; page++) {
				...
				if (hp.hasPage6 && page == 5 && chap > 1) {
					...
					html = HttpWork.getHtmlFromWithHeaderParam(hp);
					list = CollectData.getListShowFromQnSHtml(html);
					MySQLite.getInstance().SyncListShowWithFullMp3AndNumber(
							list);
					hp = HttpWork.getNextHeaderParam(html);
